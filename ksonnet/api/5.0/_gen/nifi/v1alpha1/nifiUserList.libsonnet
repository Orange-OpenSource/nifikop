{
  ...
  '#':: d.pkg(name='nifiUserList', url='', help='NifiUserList is a list of NifiUser'),
  ...
  '#new':: d.fn(help='new returns an instance of Nifiuserlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'nifi.orange.com/v1alpha1',
    kind: 'NifiUserList',
  } + self.metadata.withName(name=name),
  '#withItems':: d.fn(help='List of nifiusers. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md', args=[d.arg(name='items', type=d.T.array)]),
  withItems(items): { items: if std.isArray(v=items) then items else [items] },
  '#withItemsMixin':: d.fn(help='List of nifiusers. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='items', type=d.T.array)]),
