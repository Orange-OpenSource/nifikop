{
  ...
  '#':: d.pkg(name='nifiUserGroupList', url='', help='NifiUserGroupList is a list of NifiUserGroup'),
  ...
  '#new':: d.fn(help='new returns an instance of Nifiusergrouplist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'nifi.orange.com/v1alpha1',
    kind: 'NifiUserGroupList',
  } + self.metadata.withName(name=name),
  '#withItems':: d.fn(help='List of nifiusergroups. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md', args=[d.arg(name='items', type=d.T.array)]),
  withItems(items): { items: if std.isArray(v=items) then items else [items] },
  '#withItemsMixin':: d.fn(help='List of nifiusergroups. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='items', type=d.T.array)]),
