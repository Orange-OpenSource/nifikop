{
  ...
  '#':: d.pkg(name='nifiClusterList', url='', help='NifiClusterList is a list of NifiCluster'),
  ...
  '#new':: d.fn(help='new returns an instance of Nificlusterlist', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'nifi.orange.com/v1alpha1',
    kind: 'NifiClusterList',
  } + self.metadata.withName(name=name),
  '#withItems':: d.fn(help='List of nificlusters. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md', args=[d.arg(name='items', type=d.T.array)]),
  withItems(items): { items: if std.isArray(v=items) then items else [items] },
  '#withItemsMixin':: d.fn(help='List of nificlusters. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='items', type=d.T.array)]),
